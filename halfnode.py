...
class CAddress(object):
    __slots__ = ('nTime', 'nServices', 'pchReserved', 'ip', 'port')
...
class CTxInTemplate(CTxIn):
    __slots__ = ('_scriptSig_template',)


class CTxOut(object):
    __slots__ = ('nValue', 'scriptPubKey', 'nSequence')
...
class CTransaction(object):
    __slots__ = ('nVersion', 'vin', 'vout', 'nLockTime', 'sha256')
